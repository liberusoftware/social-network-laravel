...
final class MediaController extends Controller
{
    ...
    {
        $data = $request->validate(['type' => ['required', 'in:image,video,audio,file'], 'path' => ['required', 'string', 'max:2048'], 'disk' => ['sometimes', 'string', 'max:64'], 'mime_type' => ['nullable', 'string', 'max:160'], 'size' => ['nullable', 'integer', 'min:0'], 'checksum' => ['nullable', 'string', 'max:128'], 'alt_text' => ['nullable', 'string', 'max:1000'], 'captions' => ['nullable', 'string'], 'rights' => ['sometimes', 'array'], 'metadata' => ['sometimes', 'array']]);
