...
final class Search extends Page
{
    protected string $view = 'social-network-discovery-filament::pages.search';
    ...
    public function results(GetProfile $get, SearchDiscovery $search): mixed
    {
        if (! auth()->check() || trim($this->query) === '') {
            return collect();
        }
