...
final class EngagementController extends Controller
{
    ...
    {
        $data = $request->validate(['kind' => ['required', 'in:reaction,comment,share,bookmark'], 'reaction_type' => ['nullable', 'string', 'max:24'], 'target_type' => ['required', 'string', 'max:160'], 'target_id' => ['required', 'uuid'], 'body' => ['nullable', 'string', 'max:10000']]);
